...
import styles from './NextGenSwitchTabs.module.css';

const NextGenSwitchTabs = ({ tabs, activeTab, onTabChange, layoutIdPrefix = "activeSwitch", containerClassName = "", containerStyle = {} }) => {
    return (
...
export default NextGenSwitchTabs;
