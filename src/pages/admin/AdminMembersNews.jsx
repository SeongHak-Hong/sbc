    ...
    const handleSave = async () => {
        ...
        try {
            ...
            for (let i = 0; i < newFiles.length; i++) {
                ...
                const fileRef = ref(storage, `membersNews/${formId}/${Date.now()}_${file.name}`);
            ...
            const postData = {
                ...
                isMemberNews: true // Flag to identify in detail page if needed
            };
                ...
                <div style={{ display: 'grid', gap: '20px' }}>
                    <div style={{ display: 'flex', gap: '16px' }}>
                        ...
                        <div style={{ width: '200px' }}>
                            <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600' }}>작성자 (부서)</label>
                            <input 
                                type="text" 
                                value={author} 
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                        <tr style={{ backgroundColor: '#F9FAFB', textAlign: 'left', borderBottom: '1px solid #E5E7EB' }}>
                            ...
                            <th style={{ padding: '16px', width: '150px' }}>작성자(부서)</th>
